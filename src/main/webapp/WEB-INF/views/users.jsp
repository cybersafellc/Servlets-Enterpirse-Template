...
<html lang="en">
  ...
  <body>
    ...
    >
      <!--  App Topstrip -->
      <div
        class="app-topstrip bg-dark py-3 px-4 w-100 d-lg-flex align-items-center justify-content-between d-none"
      >
        <div
          class="d-none d-sm-flex align-items-center justify-content-center gap-9 mb-3 mb-lg-0"
        >
          <a
          ...
          <div
            class="d-none d-xl-flex align-items-center gap-3 border-start border-white border-opacity-25 ps-9"
          >
            <a
              href="https://wrappixel.com/templates/category/bootstrap-templates/"
        ...
        <div class="d-lg-flex align-items-center gap-3">
          <h3
            class="text-linear-gradient mb-3 mb-lg-0 fs-3 text-uppercase text-center fw-semibold"
          >
            <c:out value="${user.name}" />
          </h3>
          <div
            class="d-sm-flex align-items-center justify-content-center gap-8"
          >
            <div
              class="d-flex align-items-center justify-content-center gap-8 mb-3 mb-sm-0"
            >
              <div class="dropdown d-flex">
                <a
                  class="btn live-preview-drop fs-4 lh-sm btn-outline-primary rounded border-white border border-opacity-40 text-white d-flex align-items-center gap-2 px-3 py-2"
                ...
                <div
                  class="dropdown-menu p-3 dropdown-menu-end dropdown-menu-animate-up overflow-hidden rounded"
                ...
                >
                  <div class="message-body">
                    ...
                    >
                      <img
                        src="assets/images/svgs/bt-cat-icon.svg"
                        width="20"
                        alt="bootstrap"
                      />
                      Bootstrap Version
                    ...
                    >
                      <img
                        src="assets/images/svgs/next-cat-icon.svg"
                        width="18"
                        alt="next"
                      />
                      NextJs Version
                    ...
                    >
                      <img
                        src="assets/images/svgs/tailwindcss.svg"
                        width="18"
                        alt="tailwind"
                      />
                      Tailwind Version
              ...
              <a
                ...
                href="https://wrappixel.com/templates/spike-bootstrap-admin-dashboard/?ref=376"
              >
                <iconify-icon
                  class="fs-5"
            ...
            <a
              ...
              href="https://wrappixel.com/all-access-pass/?ref=376"
            >
              <iconify-icon
                class="fs-5"
          ...
          <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                ...
                >
                  ...
                  <span
                    class="hide-menu badge bg-secondary-subtle text-secondary fs-1 py-1 px-2 rounded-pill"
                    >Pro</span
                  >
                </a>
              </li>
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/index2.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between has-arrow"
                  href="javascript:void(0)"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-accordian.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-badge.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-dropdowns.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-modals.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-tab.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-tooltip-popover.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-notification.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-progressbar.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-pagination.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-bootstrap-ui.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-breadcrumb.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-offcanvas.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-lists.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-grid.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-carousel.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-scrollspy.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-spinner.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-link.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/component-sweetalert.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/component-nestable.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/component-noui-slider.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/component-rating.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/component-toastr.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-cards.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-card-customs.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-card-weather.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/ui-card-draggable.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-kanban.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/app-invoice.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/widgets-cards.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/widgets-banners.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/widgets-charts.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/widgets-feeds.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/widgets-apps.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/widgets-data.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
              ...
              <li class="sidebar-item">
                ...
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
                      <iconify-icon
                        icon="solar:cloud-file-line-duotone"
                      ></iconify-icon>
                    </span>
                    <span class="hide-menu">Pages</span>
                  </div>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/pages-animation.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/pages-search-result.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/pages-gallery.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/pages-treeview.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/pages-block-ui.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/pages-session-timeout.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/page-pricing.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/page-faq.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/page-account-settings.html"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-inputs.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-input-groups.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-input-grid.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-checkbox-radio.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-bootstrap-switch.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-select2.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-dropzone.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-mask.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-typeahead.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-basic.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-horizontal.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-actions.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-row-separator.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-bordered.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-detail.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-striped-row.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-floating-input.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-bootstrap-validation.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-custom-validation.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-picker-colorpicker.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-picker-bootstrap-rangepicker.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-picker-bootstrap-datepicker.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-picker-material-datepicker.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-editor-quill.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
                  ...
                  <li class="sidebar-item">
                    <a
                      class="sidebar-link primary-hover-bg justify-content-between"
                      target="_blank"
                      href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-editor-tinymce.html"
                    >
                      <div class="d-flex align-items-center gap-6">
                        <span class="d-flex">
                          <span class="icon-small"></span>
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-wizard.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/form-repeater.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/table-basic.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/table-dark-basic.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/table-sizing.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/table-layout-coloured.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/table-datatable-basic.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/table-datatable-api.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/table-datatable-advanced.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/chart-apex-line.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/chart-apex-area.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/chart-apex-bar.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/chart-apex-pie.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/chart-apex-radar.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link primary-hover-bg justify-content-between"
                  target="_blank"
                  href="https://bootstrapdemos.wrappixel.com/spike/dist/main/icon-solar.html"
                  aria-expanded="false"
                >
                  <div class="d-flex align-items-center gap-6">
                    <span class="d-flex">
            ...
            >
              <div class="flex-shrink-0">
                <h6 class="fw-semibold fs-4 mb-6 text-dark w-75 lh-sm">
                  Check Pro Version
                </h6>
                <a
                  href="https://wrappixel.com/templates/spike-bootstrap-admin-dashboard/?ref=376#demos"
                  target="_blank"
                  class="btn btn-secondary fs-2 fw-semibold lh-sm"
                  >Check</a
                >
              </div>
              <div class="unlimited-access-img">
                <img
                  src="assets/images/backgrounds/sidebar-buynow-bg.png"
                  alt=""
                  class="img-fluid"
                />
              </div>
                  ...
                  <div class="col-lg-12 col-sm-6">
                    ...
                    <div class="card overflow-hidden">
                      <div class="card-body p-4">
                        <h5 class="card-title mb-10 fw-semibold">
                  ...
                  <div class="card-body p-4">
                    ...
                    <ul class="timeline-widget mb-0 position-relative mb-n5">
                      ...
                      >
                        ...
                        >
                          <span
                            class="timeline-badge border-2 border border-primary flex-shrink-0 my-2"
                          ></span>
                          <span
                      ...
                      >
                        ...
                        >
                          <span
                            class="timeline-badge border-2 border border-info flex-shrink-0 my-2"
                          ></span>
                          <span
                            class="timeline-badge-border d-block flex-shrink-0"
                          ></span>
                      ...
                      >
                        ...
                        >
                          <span
                            class="timeline-badge border-2 border border-success flex-shrink-0 my-2"
                          ></span>
                          <span
                            class="timeline-badge-border d-block flex-shrink-0"
                          ></span>
                      ...
                      >
                        ...
                        >
                          <span
                            class="timeline-badge border-2 border border-warning flex-shrink-0 my-2"
                          ></span>
                          <span
                            class="timeline-badge-border d-block flex-shrink-0"
                          ></span>
                      ...
                      >
                        ...
                        >
                          <span
                            class="timeline-badge border-2 border border-danger flex-shrink-0 my-2"
                          ></span>
                          <span
                            class="timeline-badge-border d-block flex-shrink-0"
                          ></span>
